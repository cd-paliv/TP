...
public class Libro {
   ...
   private LibroAutor primerAutor; 
   ...
   private double precio; 
    ...
    int unAñoEdicion,  LibroAutor unPrimerAutor, String unISBN, double unPrecio){
         titulo = unTitulo;
    ...
    public Libro(  String unTitulo,  String unaEditorial, LibroAutor unPrimerAutor, String unISBN){
         titulo = unTitulo;
         editorial = unaEditorial; 
         añoEdicion= 2015;
         primerAutor = unPrimerAutor;
    ...
    public LibroAutor getPrimerAutor(){
        return primerAutor;
    } 
    ...
    public void setPrimerAutor(LibroAutor unPrimerAutor){
         primerAutor=unPrimerAutor;
    } 
